...
public class Pregunta implements Serializable {
    ...
    public int obtenerCantidadDePerfiles() {
        return resultadosPorPerfil.size();
    }

    public ResultadoPorPerfil obtenerResultadoPorPerfil(int i) {
        return i < resultadosPorPerfil.size() ? resultadosPorPerfil.get(i) : null;
    }
