...
public class EsperanzaDeTiempo {
    ...
    public EsperanzaDeTiempo(int cantidadDemuestras, int cantidadTrabajadores, AccionesConsultor ac, long tiempoLimiteDeEspera, TimeToCookAction timeToCook){
        ...
        for(int i=0; i<cantidadDemuestras; i++){
            obtencionDeTiempos.add(new TareaDeConexion_1(ac, valoresEsperanzaDeTiempo, i));
        }
