 ...
 * @author azaraf
 */
public class Consultor_1 extends javax.swing.JFrame {
     ...
     * @param votacion
     */
    public Consultor_1(Votacion votacion) {
        initComponents();
    ...
    private void listener(){
        ...
        int h = r.height;
        int w = r.width;
        System.out.println("Windows size: " + w + "x" + h + " pixels.");
        addWindowStateListener(new WindowStateListener() {
            
            @Override
            public void windowStateChanged(WindowEvent e) {
                System.out.println("State: " + ((Window)e.getSource()).getSize().getHeight());
            }
        });
    }
